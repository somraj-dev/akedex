...
import com.akedex.auth.domain.*;
import com.akedex.institution.domain.Campus;
import com.akedex.institution.domain.Institution;
import com.akedex.institution.domain.InstitutionRepository;
import com.akedex.institution.domain.InstitutionStatus;
import com.akedex.institution.domain.InstitutionType;
import com.akedex.students.domain.*;
import com.akedex.teachers.domain.*;
import com.akedex.workflow.domain.*;
import com.akedex.admissions.domain.*;
import com.akedex.transfers.domain.*;
import com.akedex.documents.domain.*;
